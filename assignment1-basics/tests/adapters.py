...
def run_get_batch(
    ...
    """
    Thin wrapper for cs336_basics.adapters_impl.run_get_batch_impl.
    """
...
def run_transformer_block(
    ...
    """
    Thin wrapper for cs336_basics.adapters_impl.run_transformer_block_impl.
    """
    return transformer_block_from_weights(d_model, num_heads, d_ff, max_seq_len, theta, weights, in_features)
...
def run_transformer_lm(
    ...
    """
    Thin wrapper for cs336_basics.adapters_impl.run_transformer_lm_impl.
    """
    return transformer_lm_from_weights(vocab_size, context_length, d_model, num_layers, num_heads, d_ff, rope_theta, weights, in_indices)
